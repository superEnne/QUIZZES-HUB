    ...
    reviewers: [
      {
        ...
        questions: [
          ...
          // C. Output Tracing (Calculator/Print classes)
          {
            ...
            code: "// Calculator constructors:\n// Calculator()          â†’ calls this(4,2)\n// Calculator(int a)     â†’ calls this(6.0, 3.0)\n// Calculator(int a, int b) â†’ this.ans = a - b\n// Calculator(double a, double b) â†’ this.ans = a + b\n// getAns() returns ans\n// getAns(int n): if n==0 â†’ ans+ans; else â†’ ans*ans\n\nCalculator c1 = new Calculator(4.0, 2.0);\nPrint p = new Print();\np.printAns(c1);",
            answer: "6.0",
          ...
          // C. Output Tracing (same Calculator/Print, continued)
          {
            ...
            code: "// Calculator(double a, double b) â†’ this.ans = a + b\n\nCalculator c3 = new Calculator(3.0, 2.0);\np.printAns(c3);",
            answer: "5.0",
          ...
          },
          {
            ...
            code: "// getAns(int n): if n == 0 â†’ ans + ans\n\np.printAns(c1, 0);",
            answer: "12.0",
          ...
          },
          {
            ...
            code: "// getAns(int n): if n == 1 â†’ ans * ans\n\np.printAns(c2, 1);",
            answer: "9.0",
